...
#### 1. System data flow (bird's-eye view)
...
<p align="center">
  ...
  <i>↑ Paper Algorithm 1: Deep Planning Network (right-side annotations added by this notebook). Blue = <b>A · Model fitting</b> (×C updates, lines 4-7); green = <b>B · Data collection</b> (1 new episode, lines 8-16); orange = inner action-repeat loop (lines 13-15); the top-right blue back-edge is the outer <code>while</code> that alternates A↔B until convergence. The red callouts surface three cross-chapter links the paper hides: "Equation 8 = §🔭 Overshooting ELBO", "infer belief = §🧬 RSSM dual path", "planner = §🎯 CEM".</i>
</p>
